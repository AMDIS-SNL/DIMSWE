...
parameters['model'] = 'tswe-cf' # tswe-cf tswe-lp tswe-cf-h1 ce-cf ce-lp mhd maxwell eulermaxwell scalarwave
    ...
    for method in ['AVF2',]:
        ...
        for solver in solvers[method]:
            ...
            for alpha_s in [0,1]:
                ...
                outname = method + '-order' + str(order) + '-' + solver + '-alpha' + str(alpha_s)
