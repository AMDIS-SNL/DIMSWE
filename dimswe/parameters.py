...
def get_default_parameters():
    ...
    parameters["timestepper_split_terms"] = [
        ["model"],
        [
            "hyperviscosity",
        ],
    ...
    parameters["model"] = (
        "tswe-cf-h1"  # tswe-cf tswe-lp tswe-cf-h1 ce-cf ce-lp mhd maxwell eulermaxwell scalarwave
    )
