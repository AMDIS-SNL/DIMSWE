...
print('model_coeff', model_coeff.dat.data)
print('coeff_new', coeff_new.dat.data)
print('coeff_diff', coeff_diff.dat.data)


coeff_new_arr = create_flattened_numpy_arr_from_mixed_function(coeff_new)
coeff_opt_arr = optimizer.optimize(coeff_new_arr, opt_type='coeffs', gtol=1e-5, ftol=1e-8)
